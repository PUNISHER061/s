...
//command
  if(message.author.id != 880001737182838816){
    const noperms = new MessageEmbed()
    .setDescription("این کامند فقط برای صاحب بات هست **ARSAM** ")
    .setColor("YELLOW");
...
.setTitle(`**[Support Server]**`)
  ...
  .addFields(
    ...
    { name: "<a:Owner:822760998938869760> Bot Owner:",value: `\`\`\`ARSAM\`\`\``},
  )
  .setColor("3498DB")
  .setFooter("Thx For Choosing automodbot")  

return message.channel.send(embed);
    return message.react("<:emoji_21:1006262936513302608>");
}
};
